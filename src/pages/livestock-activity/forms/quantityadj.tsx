...
export default function QuantityAdjustmentPage() {
  ...
  return (
    <>
      ...
      {!initLoading && (
        <>
          <CustomNotice<QuantityAdjFormData> formType={QTYADJ_STORAGE_KEY} onLoad={(data) => reset(data)} />
          <CustomFormsLayout>
            <CustomHeader icon={Tune} title="Quantity Adjustment" button={{ label: "reset", onClick: handleReset }} />
